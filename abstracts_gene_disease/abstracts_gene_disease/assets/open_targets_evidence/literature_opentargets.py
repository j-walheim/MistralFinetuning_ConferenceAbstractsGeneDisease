...
@asset(deps = 'raw_opentargets_literature')
def combined_partitions_literature(context: AssetExecutionContext):

    dir_raw = '../.dagster_home/storage/raw_opentargets_literature'
    ...
    try:
        ...
        output_file = '../.dagster_home/storage/raw_opentargets_literature.parquet'
